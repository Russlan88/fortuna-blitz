...
Working with Fortuna Blitz you receive a long-term reliable partner with versatile assortment who can fulfill consumers’ demands in the best quality food on your market.
			...
			<VisualContainerStyle>
				<VisualCaption initial={0} opacity={1} duration={1} src_img={VisualFirst} width={'430px'} top={'70px'} right={'40px'}/>
				<VisualCaption initial={0} delay={1} opacity={1} duration={1} src_img={VisualSecond} width={'300px'} top={'150px'} right={'355px'} zIndex={9}/>
				<VisualCaption initial={0} delay={2} opacity={1} duration={1} src_img={VisualThird} width={'360px'} top={'440px'} right={'140px'}/>
			</VisualContainerStyle>
		</HomeStyled>
	);
};
